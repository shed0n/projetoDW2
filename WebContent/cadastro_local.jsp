...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"> 
      ...
      <div class="jumbotron">
		<form  method="post" action="./CadastroSetor" class="form-horizontal" >
			<fieldset>
			<!-- Form Name -->
			<legend>Formulário de Cadastro de Setor</legend>

			
			<!-- Text input-->
			  <div class="form-group" >
			  <label class="col-md-4 control-label" for="nomeSetor">Local</label>
			  <div class="col-md-4">
			  <input id="nomeSetor" name="nomeSetor" type="text" placeholder="Nome do Local" class="form-control input-md" required>	
			  </div>
			  </div>
