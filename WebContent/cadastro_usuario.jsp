<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   import="control.CadastroUsuario" pageEncoding="ISO-8859-1"%>
...
<html lang="en">
  ...
  <body>
    ...
    %>
    <div class="container">
      <form method="post" action="./CadastroUsuario" class="form-signin">
      ...
      <form method="post"  action="login.jsp" class="form-signin">
          <button class="btn btn-lg btn-block">Voltar para o Login</button>
	  </form>
